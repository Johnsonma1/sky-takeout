...
public class Orders implements Serializable {
    ...
    public static final Integer PENDING_PAYMENT = 1;//1待付款
    public static final Integer TO_BE_CONFIRMED = 2;//2待接单
    public static final Integer CONFIRMED = 3;//3已接单
    public static final Integer DELIVERY_IN_PROGRESS = 4;//4派送中
    public static final Integer COMPLETED = 5;//5已完成
    public static final Integer CANCELLED = 6;//6已取消

    //支付状态 0未支付 1已支付 2退款
    public static final Integer UN_PAID = 0;//0未支付
    public static final Integer PAID = 1;//1已支付
    public static final Integer REFUND = 2;//2退款
